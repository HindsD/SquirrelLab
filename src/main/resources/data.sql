insert into squirrel(squirrel_id, species, common_name, habitat, ranking, image_file_name)
values(1, 'Ratufa macroura', 'Grizzled giant squirrel', 'Sri Lanka', 0, 'ggs.jpg');

insert into squirrel(squirrel_id, species, common_name, habitat, ranking, image_file_name)
values (2, 'Petaurista philippensis', 'Indian giant flying squirrel', 'India and China', 0, 'igfs.jpg');

insert into squirrel(squirrel_id, species, common_name, habitat, ranking, image_file_name)
values (3, 'Pteromys momonga', 'Japanese dwarf flying squirrel', 'Japan', 0, 'jdfs.jpg');

insert into squirrel(squirrel_id, species, common_name, habitat, ranking, image_file_name)
values (4, 'Petaurista petaurista', 'Red giant flying squirrel', 'Southeast Asia', 0, 'grfs.jpg');

insert into squirrel(squirrel_id, species, common_name, habitat, ranking, image_file_name)
values (5, 'Callosciurus prevostii', 'Prevost''s squirrel', 'Thai-Malay Peninsula', 0, 'ps.jpg');

insert into squirrel(squirrel_id, species, common_name, habitat, ranking, image_file_name)
values (6, 'Ratufa indica', 'Malabar giant squirrel', 'India', 0, 'mgs.jpg');
